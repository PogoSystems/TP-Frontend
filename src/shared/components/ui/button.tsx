...
const VARIANTS: Record<ButtonVariant, string> ={
    primary: 'bg-bg-button text-white hover:bg-accent-button px-5 py-2.5  h-full',
    secondary: 'bg-white text-text-body hover:bg-gray-100 border-1 border-gray-200 px-5 py-2.5 h-full',
