                    ...
                    {!isLoading && !error && metrics && hasActivity && (
                        ...
                        <Card className="flex flex-col gap-5 !p-6">
                            <div className="flex items-center justify-between">
                                ...
                                >
                                    <option value={ProgressGranularity.WEEK}>Semanas</option>
                                    <option value={ProgressGranularity.MONTH}>Meses</option>
                                    <option value={ProgressGranularity.YEAR}>Años</option>
                                </select>
                            </div>
