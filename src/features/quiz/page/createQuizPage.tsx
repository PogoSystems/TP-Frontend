            ...
            <Card className="w-full mt-4">
                <Card.Content>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-5 pb-4">
                        ...
                        <InputText label={'Título del cuestionario'} required={true} name={'quizTitle'}  value={'quizTitle'} placeholder={'Ej: Quiz de repaso - PC1 - Notación Big O'}/>
                        <InputText label={'Cantidad de preguntas'} required={true} name={'questionCount'} value={'questionCount'} placeholder={'10'}/>
                        <InputText label={'Tema del cuestionario'} required={true} name={'quizSubject'} value={'quizSubject'} placeholder={'Ej: Patrones de diseño, Diagramas UML, Principios SOLID'}/>
                    </div>
